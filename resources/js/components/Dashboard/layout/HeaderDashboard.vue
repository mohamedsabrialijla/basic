                ...
                <div class="d-flex align-items-center ms-1" id="kt_header_user_menu_toggle">
                    ...
                    <div class="btn btn-flex align-items-center bg-hover-white bg-hover-opacity-10 py-2 px-2 px-md-3" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        ...
                        <div class="d-none d-md-flex flex-column align-items-end justify-content-center me-2 me-md-4">
                          <span class="text-muted fs-8 fw-semibold lh-1 mb-1">{{ user ? user.name : 'Loading...' }}</span>
                          <span class="text-white fs-8 fw-bold lh-1">{{ user ? user.email : 'Loading...' }}</span>
                        </div>

                        <!--end::Name-->
                        <!--begin::Symbol-->
                        <div class="symbol symbol-30px symbol-md-40px">
                            <img :src=" user ? user.logo : 'Loading...' " alt="image" />
                        </div>
                        <!--end::Symbol-->
                    </div>
                    <!--end::User info-->
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" :src=" user ? user.logo : 'Loading...' " />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5" v-if="user && user.company_id == null "> Pro
                                    <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ user ? user.name : 'Loading...' }}</span></div>
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{{ user ? user.email : 'Loading...' }}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
...
export default {
  ...
  computed: {
    ...mapState(['user']), // يجلب بيانات المستخدم من Vuex state
  },
