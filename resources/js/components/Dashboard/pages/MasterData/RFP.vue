            ...
            <tr v-for="(item, index) in items" :key="item.id">
              ...
              <td class="align-items-center" style="margin-top: 15px;">               
                ...
                <div class="d-flex flex-column">
                  <a href="#" class="text-gray-800 text-hover-info mb-1">{{item.title}}</a>
                </div>
              </td>

              <td>
                 <div class="d-flex flex-column">
                  <a href="#" class="text-gray-800 text-hover-info mb-1 text-uppercase">{{item.type}}</a>
                </div>
              </td>
        ...
        <div class="modal-body px-5 my-7">
          <form id="kt_modal_add_user_form" class="form" action="#">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info" @click="addEditItem()">Save changes</button>
            </div>
          </form>
        </div>
