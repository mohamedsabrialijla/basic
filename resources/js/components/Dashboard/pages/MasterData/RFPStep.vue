<template>
  <div class="card">
          ...
          <form id="kt_modal_add_user_form" class="form" action="#" >
            ...
            <div class="row">
              ...
              <div class="fv-row col-md-4">
                ...
                <input type="text" name="name"  class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Type Of Event" value="" v-model="formData.type_event" required />
              </div>
    ...
    <div class="text-center pt-10">
      ...
      <a href="#" v-if="currentStep !== 0"
          @click="setStep(currentStep -1)" class="btn btn-secondary" style="margin: 7px;">
        <span class="">Previous</span>
      </a>


      <a href="#" v-if="currentStep === 0" 
          @click="openList()" class="btn btn-secondary" style="margin: 7px;">
        <span class="">Back</span>
      </a>


      <a disabled="currentStep === steps.length - 1" v-if="currentStep !== 2 "
        @click="nextStep" href="#" class="btn btn-light-primary">
...
export default {
  components: {
    Pagination,Multiselect,PricingSheet,Technical
  },
    data() {
        return {
            languages:{},
     ...
     //  },
      ...
      addEditItem(){
        ...
        this.isLoading = true;
         ...
         //    form.append('ID_rfp', this.formData.ID_rfp);
         //    form.append('category_id', this.formData.category.id);
         //    form.append('contract_id', this.formData.contract.id);
           
         //    form.append('name', this.formData.name);
            
         //    form.append('description', this.formData.description);
         //    form.append('type_event', this.formData.type_event);
         //    form.append('business_unite', this.formData.business_unite);
         //    form.append('estimated_budget', this.formData.estimated_budget);
        ...
        axios.post(this.URL,this.formData).then((response)=>{
              ...
              if(response.data.items){
                 ...
                 localStorage.setItem('object_rfp',this.formData);
